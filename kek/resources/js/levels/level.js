(function() {
  var Level = Mario.Level = function(options) {
    ...
    this.zamkSprite = options.zamkSprite;
    this.zamk2Sprite = options.zamk2Sprite;
    this.zamk3Sprite = options.zamk3Sprite;
    this.zamk4Sprite = options.zamk4Sprite;
    ...
    this.exSprites = options.exSprites;
  ...
  Level.prototype.putCoin = function(x, y) {
    ...
    this.scenery[y][x] = new Mario.Prop([x*16, y*16], this.cloudSprite);
      ...
      Level.prototype.putZamk = function(x, y) {
    this.scenery[y][x] = new Mario.Prop([x*16, y*16], this.zamkSprite);
  };
       Level.prototype.putZamk2 = function(x, y) {
    this.scenery[y][x] = new Mario.Prop([x*16, y*16], this.zamk2Sprite);
  };
       Level.prototype.putZamk3 = function(x, y) {
    this.scenery[y][x] = new Mario.Prop([x*16, y*16], this.zamk3Sprite);
  };
       Level.prototype.putZamk4 = function(x, y) {
    this.scenery[y][x] = new Mario.Prop([x*16, y*16], this.zamk4Sprite);
  };
