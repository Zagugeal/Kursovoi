var oneone = Mario.oneone = function() {
  level = new Mario.Level({
    ...
    zamkSprite: new Mario.Sprite('sprites/tiles.png', [32,0],[16,16],0),
    zamk2Sprite: new Mario.Sprite('sprites/tiles.png', [176,0],[16,16],0),
    zamk3Sprite: new Mario.Sprite('sprites/tiles.png', [208,16],[16,16],0),
    zamk4Sprite: new Mario.Sprite('sprites/tiles.png', [192,16],[16,16],0),
  ...
  ground = [[0,69],[71,86],[89,153],[155,216]];
  ...
  //сценарий
  clouds = [[7,2],[19, 2],[56, 3],[67, 2],[87, 2],[103, 2],[152, 3],[163, 2],[200, 3]];
  clouds.forEach(function(cloud){
    level.putCloud(cloud[0],cloud[1]);
  });

  zamks = [[203,12],[205,12],[203,11],[205,11]];
  zamks.forEach(function(zamk){
    level.putZamk(zamk[0],zamk[1]);
  });
    zamks2 = [[203,10],[204,10],[205,10]];
  zamks2.forEach(function(zamk2){
    level.putZamk2(zamk2[0],zamk2[1]);
  });
    zamks3 = [[204,12]];
  zamks3.forEach(function(zamk3){
    level.putZamk3(zamk3[0],zamk3[1]);
  });
    zamks4 = [[204,11]];
  zamks4.forEach(function(zamk4){
    level.putZamk4(zamk4[0],zamk4[1]);
  });
